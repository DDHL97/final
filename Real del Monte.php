<?php
	...
	$query="SELECT nom_pueblo, descripcion FROM pueblos where id_pueblo = '2'";
    $query1="SELECT p.posicionx, p.posiciony, p.id_lugar_interes, l.nombre, l.descripcion, l.imagen_lugar FROM lugares_interes l,  posicion p where l.id_lugar_interes = p.id_lugar_interes AND l.id_pueblo = '2' AND p.id_pueblo = '2'";
...
<div id="contenedor" class="containercarruselhuasca">
    <div id="myCarousel" class="carousel slide">
      ...
      <div class="carousel-inner">
        <div class="active item"><img  src="static/imgweb/realmonte/real0.png" alt="Iglesia"  width="500" height="434" /></div>
        <div class="item"><img  src="static/imgweb/realmonte/real1.jpg" alt="banner2"  width="500" height="434" /></div>
        <div class="item"><img  src="static/imgweb/realmonte/real2.jpg" alt="banner3"  width="500" height="434" /></div>
        <div class="item"><img  src="static/imgweb/realmonte/real3.jpg" alt="banner4"  width="500" height="434" /></div>
        <div class="item"><img  src="static/imgweb/realmonte/real4.jpg" alt="banner5" width="500" height="434" /></div>
      </div>
            </div>
      <!-- Carousel nav -->
